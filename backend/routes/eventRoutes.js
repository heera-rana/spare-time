...
const { newEvent, allEvents, oneEvent, deleteEvent} = require('../controller/eventController') // this brings in the fuctions from the controller files
...
router.delete('/oneEvent/:id', deleteEvent)
